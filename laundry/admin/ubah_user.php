            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Change User</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="tampil_user.php">Show User</a></li>
...
?>
<div class="container">
    <center><h3>Change User</h3></center>
    ...
    <form action="proses_ubah_user.php" method="post" enctype="multipart/form-data">
        ...
        <select name="role" class="form-control" id="">
            ...
            <option value="Kasir" <?php if($dt_user['role']=="kasir") echo 'selected' ?>>Cashier</option>
        </select>
        <br>

        <input type="submit" name="simpan" value="Change User" class="btn btn-primary">
        </form>
