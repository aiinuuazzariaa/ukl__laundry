            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Change Member</h1>
...
<div class="container">
    ...
    <form action="proses_ubah_member.php" method="post" enctype="multipart/form-data">
        ...
        Address :
        <textarea name="alamat" rows="4" value="" class="form-control"><?=$dt_member['alamat']?></textarea>
        <br>

        Gender :
        <select name="jenis_kelamin" value="<?=$dt_member['jenis_kelamin']?>" class="form-control" id="">
            <option value="L" <?php if($dt_member['jenis_kelamin']=="L") echo 'selected' ?>>Male</option>
            <option value="P"<?php if($dt_member['jenis_kelamin']=="P") echo 'selected' ?>>Female</option>
        </select>
        <br>
