            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Change Package</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="tampil_paket.php">Show Package</a></li>
...
?>
<div class="container">
    <center><h3>Change Package</h3></center>
    ...
    <form action="proses_ubah_paket.php" method="post" enctype="multipart/form-data">
        ...
        <select name="jenis" value="<?=$dt_paket['jenis']?>" class="form-control" id="">
            <option value="Kiloan">Kilo</option>
        ...
        <input type="submit" name="simpan" value="Change Package" class="btn btn-primary">
        </form>
