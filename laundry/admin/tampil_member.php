    ...
    <body class="sb-nav-fixed">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Show Member</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="home.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">Show Member</li>
                        </ol>
        ...
        <tbody>
            ...
            <tr>
                  ...
                  <td><a href="ubah_member.php?id_member=<?=$data_member['id_member']?>" class="btn btn-warning">Change</a> | <a href="hapus_member.php?id_member=<?=$data_member['id_member']?>" onclick="return confirm('Are you sure you delete this data?')" class="btn btn-danger">Delete</a></td>
