...
<html lang="en">
    <head>
        ...
        <title>Show Transaction Details</title>
    ...
    <body class="sb-nav-fixed">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Show Transaction Details</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="tampil_transaksi.php">Show Transaction</a></li>
                            <li class="breadcrumb-item active">Show Transaction Details</li>
                        </ol>
        ...
        <tbody>
            ...
            <tr>
                  ...
                  <td><?=$data_transaksi['qty']*$data_transaksi['harga']?></td>
