...
if($_POST){
    ...
    if(empty($nama)) {
        ...
        include "koneksi.php";
            ...
            if(empty($username)){
            $update=mysqli_query($conn,"update user set nama='".$nama."', username='".$username."', password='".$password."', role='".$role."', id_user='".$id_user."' where id_user = '".$id_user."' ") or die(mysqli_error($conn));
