    ...
    <body class="sb-nav-fixed">
        ...
        <tbody>
            ...
            <tr>
                  ...
                  <td><a href="ubah_user.php?id_user=<?=$data_user['id_user']?>" class="btn btn-warning">Change</a> | <a href="hapus_user.php?id_user=<?=$data_user['id_user']?>" onclick="return confirm('Are you sure you delete this data?')" class="btn btn-danger">Delete</a></td>
