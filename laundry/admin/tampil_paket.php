    ...
    <body class="sb-nav-fixed">
        ...
        <tbody>
            ...
            <tr>
                  ...
                  <td><a href="ubah_paket.php?id_paket=<?=$data_paket['id_paket']?>" class="btn btn-warning">Change</a> | <a href="hapus_paket.php?id_paket=<?=$data_paket['id_paket']?>" onclick="return confirm('Are you sure you delete this data?')" class="btn btn-danger">Delete</a></td>
            </tr>
            <?php 
