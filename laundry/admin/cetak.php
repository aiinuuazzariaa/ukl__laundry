...
<body>
    <?php
        include 'koneksi.php';
        $sql = "select transaksi.*, paket.jenis, paket.harga, user.nama as nama_user, member.nama as nama_member,member.alamat, member.telp, detail_transaksi.qty
                from transaksi
